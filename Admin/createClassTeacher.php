                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" pattern ="[A-Za-z]{1,32}" required name="firstName" value="<?php echo $row['firstName'];?>" id="exampleInputFirstName">
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Lastname<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" pattern ="[A-Za-z]{1,32}" required name="lastName" value="<?php echo $row['lastName'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                      ...
                      <input type="text" class="form-control" name="phoneNo"  pattern="[0-9]{10}" maxlength="10" value="<?php echo $row['phoneNo'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
